      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column" style="margin-top:100px;">
               <li class="nav-item">
                <a class="nav-link active" href="<?php echo "index.php"; ?>">Data Offices</a>
              </li>
              <li class="nav-item">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <?php 
           ...
           ?>
          <h2 style="margin: 30px 0 30px 0;">Offices</h2>
                ...
                <?php 
                 ...
                 <?php while($data = mysqli_fetch_array($result)): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo "update.php?nrp=".$data['officeCode']; ?>" class="btn btn-outline-warning btn-sm"> Update</a>
                      &nbsp;&nbsp;
                      <a href="<?php echo "delete.php?nrp=".$data['officeCode']; ?>" class="btn btn-outline-danger btn-sm"> Delete</a>
                    </td>
                  </tr>
                 <?php endwhile ?>
              </tbody>
